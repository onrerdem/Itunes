...
struct Album: Codable, Identifiable {
    ...
    static func example() -> Album {
        ...
        Album(wrapperType: "collection", collectionType: "Album", id: 1, artistID: 2, amgArtistID: 3,
              artistName: "Onur Erdem",
              collectionName: "Best of Onur", collectionCensoredName: "Doyamadım",
              ...
              collectionPrice: 8.99, collectionExplicitness: "", trackCount: 15, copyright: nil, country: "USA", currency: "USD", releaseDate: Date(), primaryGenreName: "Arabesk Fantezi")
