...
struct Ebook: Codable, Identifiable {
    ...
    init(id: UUID = UUID(), /*artistID: Int?,*/ artistName: String?, genres: [String]?, price: Double?, resultDescription: String?, releaseDate: String?, trackID: Int?, trackName: String?, genreIDS: [String]?, artistIDS: [Int]?, /*artistViewURL: String?,*/ artworkUrl100: String?, trackCensoredName: String?, fileSizeBytes: Int?, artworkUrl60: String?, currency: Currency, formattedPrice: String?, trackViewURL: String?, /*kind: Kind,*/ averageUserRating: Double?, userRatingCount: Int?) {
        self.id = id
